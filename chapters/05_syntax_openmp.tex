...
\item \cpp{firstprivate}(list of variables): those variables will be private to each thread, but initially will copy a value from the master thread using the default copy constructor. 
