...
\end{itemize} 
There is also a ``subprime'' implementation available in Microsoft Visual Studio 2019 (version 16.9), which has its own OpenMP runtime (\cpp{/openmp}) and an experimental support (\cpp{/openmp:llvm}) for the clang/llvm OpenMP runtime, in both cases at version 2.0. 
