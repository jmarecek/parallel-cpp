...
In C++23 and subsequent versions, we hope to see some standard syntax for defining coroutines (cf. P2502) (Coroutines provide a way to pause the execution of a function, return control to the calling code, and later resume from where it left off, without blocking the entire program), such as:
